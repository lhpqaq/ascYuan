...
def initialize_model_parallel(tensor_model_parallel_size_=1,
    ...
    #num_model_parallel_groups = world_size // model_parallel_size
...
def set_model_parallel_world_size(world_size):
    ...
    _MPU_MODEL_PARALLEL_WORLD_SIZE = world_size
...
def set_model_parallel_rank(rank):
    ...
    global _MPU_MODEL_PARALLEL_RANK
    _MPU_MODEL_PARALLEL_RANK = rank
...
def get_model_parallel_rank():
    ...
    global _MPU_MODEL_PARALLEL_RANK
    if _MPU_MODEL_PARALLEL_RANK is not None:
        return _MPU_MODEL_PARALLEL_RANK
